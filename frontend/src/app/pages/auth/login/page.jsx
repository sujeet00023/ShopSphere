...
export default function LoginPage() {
  ...
  return (
    <div className="auth-root" style={{ minHeight: '100vh', display: 'grid', gridTemplateColumns: '1fr 1fr', fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="auth-panel" style={{ background: 'linear-gradient(145deg, #7C3AED 0%, #5B21B6 60%, #3B0764 100%)', position: 'relative', overflow: 'hidden', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: 48 }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, textAlign: 'center', maxWidth: 380 }}>
          ...
          <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: 42, fontWeight: 900, color: '#fff', lineHeight: 1.1, letterSpacing: '-0.02em', marginBottom: 18 }}>
            Welcome<br /><em style={{ fontStyle: 'italic', color: '#C4B5FD' }}>back.</em>
          </h2>
        ...
        <div style={{ width: '100%', maxWidth: 400 }}>
          ...
          <div style={{ marginBottom: 36 }}>
            ...
            <p style={{ fontSize: 14, color: T.muted, margin: 0 }}>
              ...
              <Link href="/pages/auth/register" style={{ color: T.violet, fontWeight: 700, textDecoration: 'none' }}>Create one →</Link>
            </p>
          </div>
